...
import NewPlanPage from "app/pages/plans/new"
...
import { DayOfWeek, GroupName } from "./planEnums"
                                          ...
                                          <Link href={`/plans/${item.id}`} key={item.id}>
                                            <ul className="list-none">
                                              ...
                                              >
                                                ...
                                                <p>Group #: {item.groupOrder}</p>
                                                <p>Item #: {item.itemOrder}</p>
                                              </li>
                                            </ul>
                                          </Link>
                                        )}
